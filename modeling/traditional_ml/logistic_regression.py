"""
modeling/traditional_ml/logistic_regression.py

Trains a logistic regression model using hyperparameters from
modeling/config/traditional_ml.yaml. Saves the fitted model, scaler,
and held-out sets to artifacts/log_reg/.
...
if __name__ == '__main__':
    ...
    artifact_dir = PROJECT_ROOT / config['artifacts']['log_reg_dir']
    artifact_dir.mkdir(parents=True, exist_ok=True)

    model_path = artifact_dir / f'log_reg_{timestamp}.pkl'
